...
public class QuestionService {
   ...
   public List<QuestionsListDto> readAllByUserId(long u_id) {
       ...
       for(Question q : list) {
           Product product = productRepository.selectById(q.getP_id());
...
//        return list.stream().map(QuestionsListDto::fromEntity).toList();
	...
	public int answere(QuestionAnswereUpdateDto dto) {

		return questionRepository.updateAnswere(dto.toEntity());
	}
